...
/* Please see header file (DualmomoEncode.h) and Avago HCTL-2032 Datasheet for more technical details */

#include "DualmomoEncode.h"

DualmomoEncode::DualmomoEncode(unsigned char countMode)
{
...
void DualmomoEncode::XAxisReset( )
{
...
unsigned long DualmomoEncode::XAxisGetCount( )
{
   digitalWrite(MEGA_QUADRATURE_ENCODER_COUNTER_PIN_XY,   LOW);
...
// see Avago/Agilent/HP HCTL-2032 PDF for details
void DualmomoEncode::YAxisReset( )
{
...
// see Avago/Agilent/HP HCTL-2032 PDF for details
unsigned long DualmomoEncode::YAxisGetCount( )
{
...
// see Avago/Agilent/HP HCTL-2032 PDF for details
void DualmomoEncode::switchCountMode( unsigned char countMode )
{
