#ifndef DualmomoMotor_h
#define DualmomoMotor_h
...
class DualmomoMotor
{
  public:  
    // CONSTRUCTORS
    DualmomoMotor(); // Default pin selection.
    DualmomoMotor(unsigned char M1DIR, unsigned char M1PWM, unsigned char M1FB,
