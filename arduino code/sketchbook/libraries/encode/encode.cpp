...
/* Please see header file (encode.h) and Avago HCTL-2032 Datasheet for more technical details */

#include "encode.h"

encode::encode(unsigned char countMode)
{
...
unsigned long encode::XAxisGetCount( )
{
   digitalWrite(MEGA_QUADRATURE_ENCODER_COUNTER_PIN_XY,   LOW);
...
// see Avago/Agilent/HP HCTL-2032 PDF for details
unsigned long encode::YAxisGetCount( )
{
...
// see Avago/Agilent/HP HCTL-2032 PDF for details
void encode::switchCountMode( unsigned char countMode )
{
